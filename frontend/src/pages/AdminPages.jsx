...
export function WorkflowSettingsPage() {
  ...
  const loadSettings = useCallback(async () => {
    ...
    try {
      const [sendData, gmailData, automationData, accountsData] = await Promise.all([
        getEmailSendingStatus(),
        getGmailStatus(),
        getAutomationStatus(),
        getEmailAccounts(),
  ...
  return (
    <StaticAdminPage
      ...
      items={[
        ...
        ['Manager', 'Campaigns, approvals, decisions, sending'],
        ['Operator', 'Imports, drafts, checks, follow-ups'],
